 ...
 *
 */
public class project6_Ngoc_Aedon
{
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		while (repeatPlay.equalsIgnoreCase("yes"))
		{
			...
			String scrambledWord = scrambledWord(chosenWord);
	

			boolean won = won(scrambledWord, chosenWord, keyboard, TRIES);
	...
	public static String scrambledWord(String chosenWord) {
	...
	public static boolean won (String scrambledWord, String chosenWord, Scanner keyboard, final int TRIES) {
